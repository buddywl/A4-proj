...
//    char[][] mazeArray = newMaze.makeMaze("C:\\Users\\buddy\\Desktop\\CSC210\\A4-proj-1-\\maze1");
...
class SolveMaze {
  ...
  public static void main(String[] args) throws IOException {
    ...
    File maze1Path = new File((args.length > 0) ? args[0] : "maze1");
    String maze1 = maze1Path.getAbsolutePath();
    System.out.println(maze1);

    File maze2Path = new File((args.length > 0) ? args[0] : "maze2");
    String maze2 = maze2Path.getAbsolutePath();
    System.out.println(maze2);


    SolvedMaze.maze(maze1);
    SolvedMaze.maze(maze2);
    SolvedMaze.maze();
  }
